...
echo "Running solution just_the_last_digit_av.java"
java -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar solutions/just_the_last_digit_av.jar < "$1" > output.txt
if [ "$?" -ne "0" ]; then
