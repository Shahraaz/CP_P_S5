...
echo "Running solution Equidistant_bm.java"
java -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar solutions/Equidistant_bm.jar < "$1" > output.txt
if [ "$?" -ne "0" ]; then
