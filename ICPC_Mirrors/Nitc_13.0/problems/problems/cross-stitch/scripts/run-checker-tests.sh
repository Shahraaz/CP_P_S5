...
echo "Checker comment:" 1>> checker-tests.log
java -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar check.jar files/tests/checker-tests/08 files/tests/checker-tests/08.o files/tests/checker-tests/08.a 2>> checker-tests.log
if [ "$?" -ne "1" ]; then
    echo "Checker returned incorrect verdict. Expected: Wrong answer" 1>> checker-tests.log
    echo "Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment"
    read
...
echo "Checker comment:" 1>> checker-tests.log
java -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar check.jar files/tests/checker-tests/09 files/tests/checker-tests/09.o files/tests/checker-tests/09.a 2>> checker-tests.log
if [ "$?" -ne "3" ]; then
    echo "Checker returned incorrect verdict. Expected: Crashed" 1>> checker-tests.log
    echo "Checker returned incorrect verdict. Expected: Crashed. See checker-tests.log for checker comment"
    read
...
echo "Checker comment:" 1>> checker-tests.log
java -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar check.jar files/tests/checker-tests/10 files/tests/checker-tests/10.o files/tests/checker-tests/10.a 2>> checker-tests.log
if [ "$?" -ne "1" ]; then
    echo "Checker returned incorrect verdict. Expected: Wrong answer" 1>> checker-tests.log
    echo "Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment"
    read
