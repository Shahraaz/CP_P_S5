...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\08 files\tests\checker-tests\08.o files\tests\checker-tests\08.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\09 files\tests\checker-tests\09.o files\tests\checker-tests\09.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\10 files\tests\checker-tests\10.o files\tests\checker-tests\10.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\11 files\tests\checker-tests\11.o files\tests\checker-tests\11.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 2 (
    echo Checker returned incorrect verdict. Expected: Presentation error 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Presentation error. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\12 files\tests\checker-tests\12.o files\tests\checker-tests\12.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\13 files\tests\checker-tests\13.o files\tests\checker-tests\13.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\14 files\tests\checker-tests\14.o files\tests\checker-tests\14.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 1 (
    echo Checker returned incorrect verdict. Expected: Wrong answer 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Wrong answer. See checker-tests.log for checker comment
    pause 0
...
echo Checker comment: 1>> checker-tests.log
check.exe files\tests\checker-tests\15 files\tests\checker-tests\15.o files\tests\checker-tests\15.a 2>> checker-tests.log
if not %ERRORLEVEL% EQU 3 (
    echo Checker returned incorrect verdict. Expected: Crashed 1>> checker-tests.log
    echo Checker returned incorrect verdict. Expected: Crashed. See checker-tests.log for checker comment
    pause 0
