...
public class jeroen_with_superfluous_sort {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 0; i < n; i++)
			w[i] = v[i] = Integer.valueOf(ps[i]);

        // Randomly sort the numbers just to check that we don't have
        // any cases killing Java's quadratic sort, then do actual solution.
        Arrays.sort(w);
